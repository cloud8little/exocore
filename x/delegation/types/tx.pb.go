...
type UndelegationRecord struct {
	...
	// tx_nonce is the nonce of the transaction on the client chain or Exocore chain.
	// The lzNonce will be used if the undelegation is initiated from the client chain.
	// The Cosmos transaction sequence will be used when undelegating assets located on
	// the Exocore chain.
...
func (m *UndelegationRecord) GetTxNonce() uint64 {
	if m != nil {
		return m.TxNonce
	}
	return 0
...
var fileDescriptor_16596a15a828f109 = []byte{
	...
	,
}
